document.addEventListener('DOMContentLoaded', (event) => {
  ...
  const values = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000, 21000, 22000, 23000, 24000, 25000, 30000, 35000, 40000, 45000, 50000, 60000, 70000, 80000, 90000, 100000,250000,500000,750000, 1000000 ];
  let seatCount = 1;
  let seatValue = 1;
  let ftotal = 0;
  let totval = 0;
